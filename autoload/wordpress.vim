...
function! s:WithDirConstructor(...)
  ...
  let withDirObj.set_dir = function('s:WithDir_set_dir')
  let withDirObj.get_dir = function('s:WithDir_get_dir')
  let withDirObj.get_trap_errors = function('s:WithDir_get_trap_errors')
  let withDirObj.set_trap_errors = function('s:WithDir_set_trap_errors')
  let withDirObj.run = function('s:WithDir_run')
  return withDirObj
endfunction
...
function! s:TagsOptionConstructor()
  ...
  let tagsOptionObj.append = function('s:TagsOption_append')
  let tagsOptionObj.prepend = function('s:TagsOption_prepend')
  let tagsOptionObj.get_tags = function('s:TagsOption_get_tags')
  let tagsOptionObj.set_tags = function('s:TagsOption_set_tags')
  let tagsOptionObj.to_list = function('s:TagsOption_to_list')
  let tagsOptionObj.to_value = function('s:TagsOption_to_value')
...
function! s:ChoicePrompterConstructor()
  ...
  let choicePrompterObj.prompt_for = function('s:ChoicePrompter_prompt_for')
  let choicePrompterObj.get_input = function('s:ChoicePrompter_get_input')
  let choicePrompterObj.validate = function('s:ChoicePrompter_validate')
...
function! s:WpSeekApiConstructor()
  ...
  let wpSeekApiObj.find_similar = function('s:WpSeekApi_find_similar')
  let wpSeekApiObj.find_topics = function('s:WpSeekApi_find_topics')
  let wpSeekApiObj.is_false = function('s:WpSeekApi_is_false')
  let wpSeekApiObj.to_query = function('s:WpSeekApi_to_query')
  let wpSeekApiObj.to_function_names = function('s:WpSeekApi_to_function_names')
  let wpSeekApiObj.get_result_items = function('s:WpSeekApi_get_result_items')
  let wpSeekApiObj.invoke = function('s:WpSeekApi_invoke')
  let wpSeekApiObj.has_python = function('s:WpSeekApi_has_python')
  let wpSeekApiObj.load_api = function('s:WpSeekApi_load_api')
  let wpSeekApiObj.loaded = function('s:WpSeekApi_loaded')
  let wpSeekApiObj.get_api_path = function('s:WpSeekApi_get_api_path')
  return wpSeekApiObj
endfunction
...
function! s:HookMatchConstructor(...)
  ...
  let hookMatchObj.set_keyword = function('s:HookMatch_set_keyword')
  let hookMatchObj.set_kind = function('s:HookMatch_set_kind')
  let hookMatchObj.get_kind = function('s:HookMatch_get_kind')
  let hookMatchObj.get_keyword = function('s:HookMatch_get_keyword')
  let hookMatchObj.is_match = function('s:HookMatch_is_match')
  return hookMatchObj
endfunction
...
function! s:HookMatcherConstructor()
  let hookMatcherObj = {}
  let hookMatcherObj.lookup = function('s:HookMatcher_lookup')
  let hookMatcherObj.match = function('s:HookMatcher_match')
  let hookMatcherObj.is_kind_line = function('s:HookMatcher_is_kind_line')
  let hookMatcherObj.is_word_line = function('s:HookMatcher_is_word_line')
  let hookMatcherObj.get_kind_pattern = function('s:HookMatcher_get_kind_pattern')
  let hookMatcherObj.get_word_pattern = function('s:HookMatcher_get_word_pattern')
  let hookMatcherObj.get_kinds = function('s:HookMatcher_get_kinds')
...
function! s:ReadmeValidatorConstructor()
  ...
  let readmeValidatorObj.validate = function('s:ReadmeValidator_validate')
  let readmeValidatorObj.has_python = function('s:ReadmeValidator_has_python')
  let readmeValidatorObj.load_api = function('s:ReadmeValidator_load_api')
  let readmeValidatorObj.loaded = function('s:ReadmeValidator_loaded')
  let readmeValidatorObj.get_api_path = function('s:ReadmeValidator_get_api_path')
...
function! s:BufferTypeDetectorConstructor()
  ...
  let bufferTypeDetectorObj.get_project_path = function('s:BufferTypeDetector_get_project_path')
  let bufferTypeDetectorObj.get_parent_path = function('s:BufferTypeDetector_get_parent_path')
  let bufferTypeDetectorObj.is_core_path = function('s:BufferTypeDetector_is_core_path')
...
function! s:CoreDetectorConstructor()
  ...
  let coreDetectorObj.detect = function('s:CoreDetector_detect')
  let coreDetectorObj.get_type = function('s:CoreDetector_get_type')
...
function! s:WpCliDetectorConstructor()
  ...
  let wpCliDetectorObj.detect = function('s:WpCliDetector_detect')
  let wpCliDetectorObj.get_wp_cli_configs = function('s:WpCliDetector_get_wp_cli_configs')
  let wpCliDetectorObj.has_wp_cli = function('s:WpCliDetector_has_wp_cli')
  let wpCliDetectorObj.get_type = function('s:WpCliDetector_get_type')
...
function! s:PluginDetectorConstructor()
  ...
  let pluginDetectorObj.detect = function('s:PluginDetector_detect')
  let pluginDetectorObj.is_plugin = function('s:PluginDetector_is_plugin')
  let pluginDetectorObj.has_plugin_file = function('s:PluginDetector_has_plugin_file')
  let pluginDetectorObj.has_plugin_header = function('s:PluginDetector_has_plugin_header')
  let pluginDetectorObj.get_type = function('s:PluginDetector_get_type')
...
function! s:ThemeDetectorConstructor()
  ...
  let themeDetectorObj.detect = function('s:ThemeDetector_detect')
  let themeDetectorObj.get_wp_path = function('s:ThemeDetector_get_wp_path')
  let themeDetectorObj.has_theme_header = function('s:ThemeDetector_has_theme_header')
  let themeDetectorObj.get_type = function('s:ThemeDetector_get_type')
...
function! s:BufferConstructor(path)
  ...
  let bufferObj.scan = function('s:Buffer_scan')
  let bufferObj.get_detectors = function('s:Buffer_get_detectors')
  let bufferObj.get_type = function('s:Buffer_get_type')
  let bufferObj.get_project_path = function('s:Buffer_get_project_path')
  let bufferObj.get_path = function('s:Buffer_get_path')
  let bufferObj.get_full_path = function('s:Buffer_get_full_path')
  let bufferObj.get_parent_path = function('s:Buffer_get_parent_path')
  let bufferObj.to_full_path = function('s:Buffer_to_full_path')
  let bufferObj.destroy = function('s:Buffer_destroy')
  return bufferObj
endfunction
...
function! s:BufferCollectionConstructor()
  ...
  let bufferCollectionObj.size = function('s:BufferCollection_size')
  let bufferCollectionObj.add = function('s:BufferCollection_add')
  let bufferCollectionObj.remove = function('s:BufferCollection_remove')
  let bufferCollectionObj.contains = function('s:BufferCollection_contains')
  let bufferCollectionObj.contains_path = function('s:BufferCollection_contains_path')
  let bufferCollectionObj.buffer_for = function('s:BufferCollection_buffer_for')
...
function! s:WpCliPathConstructor()
  ...
  let wpCliPathObj.get_path = function('s:WpCliPath_get_path')
  let wpCliPathObj.exists = function('s:WpCliPath_exists')
  let wpCliPathObj.find = function('s:WpCliPath_find')
  let wpCliPathObj.is_executable = function('s:WpCliPath_is_executable')
  let wpCliPathObj.vendor_cli_path = function('s:WpCliPath_vendor_cli_path')
  return wpCliPathObj
endfunction
...
function! s:WpCliConfigConstructor()
  ...
  let wpCliConfigObj.get_config_param = function('s:WpCliConfig_get_config_param')
  let wpCliConfigObj.load = function('s:WpCliConfig_load')
  let wpCliConfigObj.parse = function('s:WpCliConfig_parse')
  let wpCliConfigObj.parse_line = function('s:WpCliConfig_parse_line')
  let wpCliConfigObj.read = function('s:WpCliConfig_read')
  let wpCliConfigObj.get_config_path = function('s:WpCliConfig_get_config_path')
  let wpCliConfigObj.local_config_path_for = function('s:WpCliConfig_local_config_path_for')
  let wpCliConfigObj.config_path_for = function('s:WpCliConfig_config_path_for')
  let wpCliConfigObj.global_config_path_for = function('s:WpCliConfig_global_config_path_for')
...
function! s:WpCliPrinterConstructor()
  ...
  let wpCliPrinterObj.print = function('s:WpCliPrinter_print')
  let wpCliPrinterObj.print_json = function('s:WpCliPrinter_print_json')
  let wpCliPrinterObj.print_text = function('s:WpCliPrinter_print_text')
  let wpCliPrinterObj.replace = function('s:WpCliPrinter_replace')
  let wpCliPrinterObj.get_command_pattern = function('s:WpCliPrinter_get_command_pattern')
  let wpCliPrinterObj.get_help_pattern = function('s:WpCliPrinter_get_help_pattern')
  let wpCliPrinterObj.get_command_replacement = function('s:WpCliPrinter_get_command_replacement')
  let wpCliPrinterObj.get_help_replacement = function('s:WpCliPrinter_get_help_replacement')
  let wpCliPrinterObj.print_line = function('s:WpCliPrinter_print_line')
  let wpCliPrinterObj.replace_tabs = function('s:WpCliPrinter_replace_tabs')
  let wpCliPrinterObj.replace_colors = function('s:WpCliPrinter_replace_colors')
  let wpCliPrinterObj.is_json = function('s:WpCliPrinter_is_json')
  let wpCliPrinterObj.lines_for = function('s:WpCliPrinter_lines_for')
...
function! s:WpCliCompleterConstructor()
  ...
  let wpCliCompleterObj.needs = function('s:WpCliCompleter_needs')
  let wpCliCompleterObj.complete = function('s:WpCliCompleter_complete')
  let wpCliCompleterObj.trim_choices = function('s:WpCliCompleter_trim_choices')
  let wpCliCompleterObj.trim = function('s:WpCliCompleter_trim')
  let wpCliCompleterObj.to_complete_args = function('s:WpCliCompleter_to_complete_args')
  let wpCliCompleterObj.to_cursor_arg = function('s:WpCliCompleter_to_cursor_arg')
  let wpCliCompleterObj.to_line_arg = function('s:WpCliCompleter_to_line_arg')
  let wpCliCompleterObj.to_wpcli_line = function('s:WpCliCompleter_to_wpcli_line')
...
function! s:WpCliRunnerConstructor()
  let wpCliRunnerObj = {}
  let wpCliRunnerObj.needs = function('s:WpCliRunner_needs')
  let wpCliRunnerObj.run = function('s:WpCliRunner_run')
  let wpCliRunnerObj.to_cli_params = function('s:WpCliRunner_to_cli_params')
  let wpCliRunnerObj.wants_help = function('s:WpCliRunner_wants_help')
...
function! s:PostConstructor()
  ...
  let postObj.needs = function('s:Post_needs')
  let postObj.create = function('s:Post_create')
  let postObj.update = function('s:Post_update')
  let postObj.find = function('s:Post_find')
  let postObj.to_arg = function('s:Post_to_arg')
  let postObj.to_post_id = function('s:Post_to_post_id')
  return postObj
endfunction
...
function! s:CTagsBuilderConstructor()
  ...
  let cTagsBuilderObj.needs = function('s:CTagsBuilder_needs')
  let cTagsBuilderObj.clean = function('s:CTagsBuilder_clean')
  let cTagsBuilderObj.generate = function('s:CTagsBuilder_generate')
  let cTagsBuilderObj.set_project_path = function('s:CTagsBuilder_set_project_path')
  let cTagsBuilderObj.get_project_path = function('s:CTagsBuilder_get_project_path')
  let cTagsBuilderObj.get_tags_name = function('s:CTagsBuilder_get_tags_name')
  let cTagsBuilderObj.get_project_tags = function('s:CTagsBuilder_get_project_tags')
  let cTagsBuilderObj.get_executable = function('s:CTagsBuilder_get_executable')
  let cTagsBuilderObj.has_executable = function('s:CTagsBuilder_has_executable')
  let cTagsBuilderObj.has_tags = function('s:CTagsBuilder_has_tags')
  let cTagsBuilderObj.get_with_dir = function('s:CTagsBuilder_get_with_dir')
  let cTagsBuilderObj.run = function('s:CTagsBuilder_run')
  let cTagsBuilderObj.build = function('s:CTagsBuilder_build')
...
function! s:LeetConvertorConstructor()
  ...
  let leetConvertorObj.convert = function('s:LeetConvertor_convert')
  let leetConvertorObj.convert_char = function('s:LeetConvertor_convert_char')
  let leetConvertorObj.get_basic_dict = function('s:LeetConvertor_get_basic_dict')
  let leetConvertorObj.get_lower_case_dict = function('s:LeetConvertor_get_lower_case_dict')
...
function! s:CTagsCommandBuilderConstructor()
  ...
  let cTagsCommandBuilderObj.needs = function('s:CTagsCommandBuilder_needs')
  let cTagsCommandBuilderObj.build = function('s:CTagsCommandBuilder_build')
  let cTagsCommandBuilderObj.get_exclude_dirs = function('s:CTagsCommandBuilder_get_exclude_dirs')
  let cTagsCommandBuilderObj.to_invocation_regex = function('s:CTagsCommandBuilder_to_invocation_regex')
  let cTagsCommandBuilderObj.to_listener_regex = function('s:CTagsCommandBuilder_to_listener_regex')
  let cTagsCommandBuilderObj.to_tag_regex = function('s:CTagsCommandBuilder_to_tag_regex')
  let cTagsCommandBuilderObj.to_kind = function('s:CTagsCommandBuilder_to_kind')
  let cTagsCommandBuilderObj.to_capture_group = function('s:CTagsCommandBuilder_to_capture_group')
  let cTagsCommandBuilderObj.to_invocation_pattern = function('s:CTagsCommandBuilder_to_invocation_pattern')
  let cTagsCommandBuilderObj.to_listener_pattern = function('s:CTagsCommandBuilder_to_listener_pattern')
  let cTagsCommandBuilderObj.get_tags_name = function('s:CTagsCommandBuilder_get_tags_name')
  let cTagsCommandBuilderObj.get_executable = function('s:CTagsCommandBuilder_get_executable')
  let cTagsCommandBuilderObj.has_executable = function('s:CTagsCommandBuilder_has_executable')
  let cTagsCommandBuilderObj.has_exuberant_executable = function('s:CTagsCommandBuilder_has_exuberant_executable')
  let cTagsCommandBuilderObj.to_leet = function('s:CTagsCommandBuilder_to_leet')
  let cTagsCommandBuilderObj.get_action_uid = function('s:CTagsCommandBuilder_get_action_uid')
  let cTagsCommandBuilderObj.get_action_listener_uid = function('s:CTagsCommandBuilder_get_action_listener_uid')
  let cTagsCommandBuilderObj.get_filter_uid = function('s:CTagsCommandBuilder_get_filter_uid')
  let cTagsCommandBuilderObj.get_filter_listener_uid = function('s:CTagsCommandBuilder_get_filter_listener_uid')
...
function! s:CtrlPAgentConstructor(registry)
  ...
  let ctrlPAgentObj.set_ex_opts = function('s:CtrlPAgent_set_ex_opts')
  let ctrlPAgentObj.has_bang = function('s:CtrlPAgent_has_bang')
  let ctrlPAgentObj.has_command = function('s:CtrlPAgent_has_command')
  let ctrlPAgentObj.get_cmd_line = function('s:CtrlPAgent_get_cmd_line')
...
function! s:JSONParserConstructor()
  ...
  let jSONParserObj.clean = function('s:JSONParser_clean')
...
function! s:WpCliConstructor()
  ...
  let wpCliObj.set_path = function('s:WpCli_set_path')
  let wpCliObj.get_path = function('s:WpCli_get_path')
  let wpCliObj.add_env_var = function('s:WpCli_add_env_var')
  let wpCliObj.remove_env_var = function('s:WpCli_remove_env_var')
  let wpCliObj.get_env_vars = function('s:WpCli_get_env_vars')
  let wpCliObj.build = function('s:WpCli_build')
  let wpCliObj.exec = function('s:WpCli_exec')
  let wpCliObj.parse = function('s:WpCli_parse')
  let wpCliObj.get_parser = function('s:WpCli_get_parser')
  let wpCliObj.run = function('s:WpCli_run')
  let wpCliObj.dump = function('s:WpCli_dump')
  let wpCliObj.list = function('s:WpCli_list')
  return wpCliObj
endfunction
...
function! s:WordPressPathConstructor()
  ...
  let wordPressPathObj.needs = function('s:WordPressPath_needs')
  let wordPressPathObj.get_path = function('s:WordPressPath_get_path')
  let wordPressPathObj.get_detectors = function('s:WordPressPath_get_detectors')
  let wordPressPathObj.find_wp_cli_project_path = function('s:WordPressPath_find_wp_cli_project_path')
  let wordPressPathObj.to_abs_path = function('s:WordPressPath_to_abs_path')
  let wordPressPathObj.calc_abs_path = function('s:WordPressPath_calc_abs_path')
...
function! s:WordPressCommandConstructor(container)
  ...
  let wordPressCommandObj.lookup = function('s:WordPressCommand_lookup')
  let wordPressCommandObj.process = function('s:WordPressCommand_process')
  let wordPressCommandObj.current_buffer = function('s:WordPressCommand_current_buffer')
  let wordPressCommandObj.current_buffer_full_path = function('s:WordPressCommand_current_buffer_full_path')
  let wordPressCommandObj.current_buffer_project_path = function('s:WordPressCommand_current_buffer_project_path')
  let wordPressCommandObj.current_project = function('s:WordPressCommand_current_project')
  let wordPressCommandObj.expand_args = function('s:WordPressCommand_expand_args')
  let wordPressCommandObj.get_current_word = function('s:WordPressCommand_get_current_word')
  let wordPressCommandObj.get_selected_text = function('s:WordPressCommand_get_selected_text')
  let wordPressCommandObj.get_current_line = function('s:WordPressCommand_get_current_line')
  let wordPressCommandObj.is_false = function('s:WordPressCommand_is_false')
  let wordPressCommandObj.is_true = function('s:WordPressCommand_is_true')
...
function! s:WordPressProjectCommandConstructor(container)
  ...
  let wordPressProjectCommandObj.lookup = function('s:WordPressProjectCommand_lookup')
...
function! s:WpCliCommandConstructor(container)
  ...
  let wpCliCommandObj.get_auto_register = function('s:WpCliCommand_get_auto_register')
  let wpCliCommandObj.has_ex_mode = function('s:WpCliCommand_has_ex_mode')
  let wpCliCommandObj.get_completer = function('s:WpCliCommand_get_completer')
  let wpCliCommandObj.get_name = function('s:WpCliCommand_get_name')
  let wpCliCommandObj.set_cmd_name = function('s:WpCliCommand_set_cmd_name')
  let wpCliCommandObj.get_cmd_name = function('s:WpCliCommand_get_cmd_name')
  let wpCliCommandObj.complete = function('s:WpCliCommand_complete')
  let wpCliCommandObj.run = function('s:WpCliCommand_run')
  let wpCliCommandObj.get_with_dir = function('s:WpCliCommand_get_with_dir')
  let wpCliCommandObj.do_run = function('s:WpCliCommand_do_run')
  let wpCliCommandObj.do_complete = function('s:WpCliCommand_do_complete')
  let wpCliCommandObj.has_hyphen = function('s:WpCliCommand_has_hyphen')
  let wpCliCommandObj.get_dehyphenated_name = function('s:WpCliCommand_get_dehyphenated_name')
  let wpCliCommandObj.get_dehyphenated_cmd_line = function('s:WpCliCommand_get_dehyphenated_cmd_line')
...
function! s:EvalFileCommandConstructor(container)
  ...
  let evalFileCommandObj.run = function('s:EvalFileCommand_run')
...
function! s:EvalCommandConstructor(container)
  ...
  let evalCommandObj.get_range = function('s:EvalCommand_get_range')
  let evalCommandObj.run = function('s:EvalCommand_run')
  let evalCommandObj.to_eval_text = function('s:EvalCommand_to_eval_text')
...
function! s:PostSaverConstructor()
  ...
  let postSaverObj.needs = function('s:PostSaver_needs')
  let postSaverObj.set_post_id = function('s:PostSaver_set_post_id')
  let postSaverObj.get_post_id = function('s:PostSaver_get_post_id')
  let postSaverObj.watch = function('s:PostSaver_watch')
  let postSaverObj.before_file_save = function('s:PostSaver_before_file_save')
  let postSaverObj.after_file_save = function('s:PostSaver_after_file_save')
  let postSaverObj.load_current_buffer = function('s:PostSaver_load_current_buffer')
  let postSaverObj.post_exists = function('s:PostSaver_post_exists')
  let postSaverObj.message_for = function('s:PostSaver_message_for')
  return postSaverObj
endfunction
...
function! s:PostCommandConstructor(container)
  ...
  let postCommandObj.run = function('s:PostCommand_run')
  let postCommandObj.load_post_into = function('s:PostCommand_load_post_into')
  let postCommandObj.get_temp_file = function('s:PostCommand_get_temp_file')
  let postCommandObj.open_temp_buffer = function('s:PostCommand_open_temp_buffer')
  let postCommandObj.get_post_options = function('s:PostCommand_get_post_options')
...
function! s:PostOptionsConstructor()
  let postOptionsObj = {}
  let postOptionsObj.parse = function('s:PostOptions_parse')
  let postOptionsObj.parse_params = function('s:PostOptions_parse_params')
...
function! s:ScaffoldCommandConstructor(container)
  ...
  let scaffoldCommandObj.do_run = function('s:ScaffoldCommand_do_run')
  let scaffoldCommandObj.get_underscore_theme_file = function('s:ScaffoldCommand_get_underscore_theme_file')
  let scaffoldCommandObj.open_file = function('s:ScaffoldCommand_open_file')
  let scaffoldCommandObj.get_file_open_mode = function('s:ScaffoldCommand_get_file_open_mode')
  let scaffoldCommandObj.find_scaffold_file = function('s:ScaffoldCommand_find_scaffold_file')
  let scaffoldCommandObj.insert_into_buffer = function('s:ScaffoldCommand_insert_into_buffer')
  let scaffoldCommandObj.WpCliCommand_do_run = function('s:WpCliCommand_do_run')
  let scaffoldCommandObj.WpCliCommand_do_run = function('s:WpCliCommand_do_run')
...
function! s:ShellCommandConstructor(container)
  ...
  let shellCommandObj.do_run = function('s:ShellCommand_do_run')
  let shellCommandObj.get_shell_cmd = function('s:ShellCommand_get_shell_cmd')
  let shellCommandObj.run_shell = function('s:ShellCommand_run_shell')
  let shellCommandObj.WpCliCommand_do_run = function('s:WpCliCommand_do_run')
...
function! s:WpCliMissingCommandConstructor(container)
  ...
  let wpCliMissingCommandObj.get_auto_register = function('s:WpCliMissingCommand_get_auto_register')
  let wpCliMissingCommandObj.has_ex_mode = function('s:WpCliMissingCommand_has_ex_mode')
  let wpCliMissingCommandObj.get_nargs = function('s:WpCliMissingCommand_get_nargs')
  let wpCliMissingCommandObj.get_bang = function('s:WpCliMissingCommand_get_bang')
  let wpCliMissingCommandObj.get_completer = function('s:WpCliMissingCommand_get_completer')
  let wpCliMissingCommandObj.get_name = function('s:WpCliMissingCommand_get_name')
  let wpCliMissingCommandObj.get_aliases = function('s:WpCliMissingCommand_get_aliases')
  let wpCliMissingCommandObj.complete = function('s:WpCliMissingCommand_complete')
  let wpCliMissingCommandObj.run = function('s:WpCliMissingCommand_run')
  let wpCliMissingCommandObj.set_cmd_name = function('s:WpCliMissingCommand_set_cmd_name')
  let wpCliMissingCommandObj.get_cmd_name = function('s:WpCliMissingCommand_get_cmd_name')
...
function! s:WpCliCommandFactoryConstructor()
  ...
  let wpCliCommandFactoryObj.build = function('s:WpCliCommandFactory_build')
  let wpCliCommandFactoryObj.command_for = function('s:WpCliCommandFactory_command_for')
...
function! s:ProjectConstructor()
  ...
  let projectObj.on_inject = function('s:Project_on_inject')
  let projectObj.lookup = function('s:Project_lookup')
  let projectObj.load = function('s:Project_load')
  let projectObj.get_root = function('s:Project_get_root')
  let projectObj.get_wpcli_commands = function('s:Project_get_wpcli_commands')
  let projectObj.get_commands = function('s:Project_get_commands')
  let projectObj.load_commands = function('s:Project_load_commands')
  let projectObj.has_cli = function('s:Project_has_cli')
  let projectObj.get_wordpress_path = function('s:Project_get_wordpress_path')
  let projectObj.has_wordpress_path = function('s:Project_has_wordpress_path')
  let projectObj.destroy = function('s:Project_destroy')
  let projectObj.load_wpcli = function('s:Project_load_wpcli')
  let projectObj.load_wordpress_path = function('s:Project_load_wordpress_path')
  let projectObj.load_ctags_builder = function('s:Project_load_ctags_builder')
  let projectObj.get_wpcli = function('s:Project_get_wpcli')
  return projectObj
endfunction
...
function! s:ProjectCollectionConstructor()
  ...
  let projectCollectionObj.needs = function('s:ProjectCollection_needs')
  let projectCollectionObj.lookup = function('s:ProjectCollection_lookup')
  let projectCollectionObj.size = function('s:ProjectCollection_size')
  let projectCollectionObj.add = function('s:ProjectCollection_add')
  let projectCollectionObj.remove = function('s:ProjectCollection_remove')
  let projectCollectionObj.contains = function('s:ProjectCollection_contains')
  let projectCollectionObj.project_for = function('s:ProjectCollection_project_for')
  let projectCollectionObj.clear = function('s:ProjectCollection_clear')
...
function! s:LoadSyntaxCommandConstructor(container)
  ...
  let loadSyntaxCommandObj.is_php_buffer = function('s:LoadSyntaxCommand_is_php_buffer')
  let loadSyntaxCommandObj.is_readme_buffer = function('s:LoadSyntaxCommand_is_readme_buffer')
  let loadSyntaxCommandObj.load_php_syntax = function('s:LoadSyntaxCommand_load_php_syntax')
  let loadSyntaxCommandObj.load_readme_syntax = function('s:LoadSyntaxCommand_load_readme_syntax')
  let loadSyntaxCommandObj.load_readme_auto_validator = function('s:LoadSyntaxCommand_load_readme_auto_validator')
  let loadSyntaxCommandObj.needs_readme_auto_validator = function('s:LoadSyntaxCommand_needs_readme_auto_validator')
...
function! s:LoadProjectRegistryCommandConstructor(container)
  ...
  let loadProjectRegistryCommandObj.get_name = function('s:LoadProjectRegistryCommand_get_name')
  let loadProjectRegistryCommandObj.run = function('s:LoadProjectRegistryCommand_run')
...
function! s:ConfigureTagsCommandConstructor(container)
  ...
  let configureTagsCommandObj.get_name = function('s:ConfigureTagsCommand_get_name')
  let configureTagsCommandObj.has_ex_mode = function('s:ConfigureTagsCommand_has_ex_mode')
  let configureTagsCommandObj.run = function('s:ConfigureTagsCommand_run')
  let configureTagsCommandObj.generate_ctags = function('s:ConfigureTagsCommand_generate_ctags')
  let configureTagsCommandObj.regenerate_ctags = function('s:ConfigureTagsCommand_regenerate_ctags')
  let configureTagsCommandObj.needs_tags_generation = function('s:ConfigureTagsCommand_needs_tags_generation')
  let configureTagsCommandObj.configure_tag_option = function('s:ConfigureTagsCommand_configure_tag_option')
...
function! s:CodexSearchCommandConstructor(container)
  ...
  let codexSearchCommandObj.get_name = function('s:CodexSearchCommand_get_name')
  let codexSearchCommandObj.get_bang = function('s:CodexSearchCommand_get_bang')
  let codexSearchCommandObj.get_auto_register = function('s:CodexSearchCommand_get_auto_register')
  let codexSearchCommandObj.get_range = function('s:CodexSearchCommand_get_range')
  let codexSearchCommandObj.has_ex_mode = function('s:CodexSearchCommand_has_ex_mode')
  let codexSearchCommandObj.run = function('s:CodexSearchCommand_run')
  let codexSearchCommandObj.get_codex_query = function('s:CodexSearchCommand_get_codex_query')
  let codexSearchCommandObj.has_open_browser = function('s:CodexSearchCommand_has_open_browser')
  let codexSearchCommandObj.urlencode = function('s:CodexSearchCommand_urlencode')
...
function! s:TagMatchConstructor(keyword, status, ...)
  ...
  let tagMatchObj.get_keyword = function('s:TagMatch_get_keyword')
  let tagMatchObj.is_match = function('s:TagMatch_is_match')
  let tagMatchObj.get_position = function('s:TagMatch_get_position')
  return tagMatchObj
endfunction
...
function! s:TagListMatcherConstructor()
  ...
  let tagListMatcherObj.match = function('s:TagListMatcher_match')
  let tagListMatcherObj.get_taglist = function('s:TagListMatcher_get_taglist')
  let tagListMatcherObj.is_function = function('s:TagListMatcher_is_function')
  let tagListMatcherObj.is_stub_function = function('s:TagListMatcher_is_stub_function')
  let tagListMatcherObj.is_variable = function('s:TagListMatcher_is_variable')
...
function! s:GotoDefinitionCommandConstructor(container)
  ...
  let gotoDefinitionCommandObj.get_name = function('s:GotoDefinitionCommand_get_name')
  let gotoDefinitionCommandObj.has_ex_mode = function('s:GotoDefinitionCommand_has_ex_mode')
  let gotoDefinitionCommandObj.get_auto_register = function('s:GotoDefinitionCommand_get_auto_register')
  let gotoDefinitionCommandObj.get_range = function('s:GotoDefinitionCommand_get_range')
  let gotoDefinitionCommandObj.run = function('s:GotoDefinitionCommand_run')
  let gotoDefinitionCommandObj.jump_to = function('s:GotoDefinitionCommand_jump_to')
  let gotoDefinitionCommandObj.jump_to_hook = function('s:GotoDefinitionCommand_jump_to_hook')
  let gotoDefinitionCommandObj.to_hook_command = function('s:GotoDefinitionCommand_to_hook_command')
  let gotoDefinitionCommandObj.get_jump_cmd = function('s:GotoDefinitionCommand_get_jump_cmd')
  let gotoDefinitionCommandObj.to_display_word = function('s:GotoDefinitionCommand_to_display_word')
  let gotoDefinitionCommandObj.strip_prefix = function('s:GotoDefinitionCommand_strip_prefix')
...
function! s:LoadMappingsCommandConstructor(container)
  ...
  let loadMappingsCommandObj.get_name = function('s:LoadMappingsCommand_get_name')
  let loadMappingsCommandObj.run = function('s:LoadMappingsCommand_run')
  let loadMappingsCommandObj.needs_jump_mappings = function('s:LoadMappingsCommand_needs_jump_mappings')
  let loadMappingsCommandObj.load_jump_mappings = function('s:LoadMappingsCommand_load_jump_mappings')
  let loadMappingsCommandObj.get_def_delegate = function('s:LoadMappingsCommand_get_def_delegate')
  let loadMappingsCommandObj.jump_to_def = function('s:LoadMappingsCommand_jump_to_def')
...
function! s:SimilarFunctionsCommandConstructor(container)
  ...
  let similarFunctionsCommandObj.get_name = function('s:SimilarFunctionsCommand_get_name')
  let similarFunctionsCommandObj.get_auto_register = function('s:SimilarFunctionsCommand_get_auto_register')
  let similarFunctionsCommandObj.has_ex_mode = function('s:SimilarFunctionsCommand_has_ex_mode')
  let similarFunctionsCommandObj.get_range = function('s:SimilarFunctionsCommand_get_range')
  let similarFunctionsCommandObj.run = function('s:SimilarFunctionsCommand_run')
...
function! s:SimilarTopicsCommandConstructor(container)
  ...
  let similarTopicsCommandObj.get_name = function('s:SimilarTopicsCommand_get_name')
  let similarTopicsCommandObj.get_auto_register = function('s:SimilarTopicsCommand_get_auto_register')
  let similarTopicsCommandObj.has_ex_mode = function('s:SimilarTopicsCommand_has_ex_mode')
  let similarTopicsCommandObj.get_range = function('s:SimilarTopicsCommand_get_range')
  let similarTopicsCommandObj.run = function('s:SimilarTopicsCommand_run')
  let similarTopicsCommandObj.to_topic_labels = function('s:SimilarTopicsCommand_to_topic_labels')
...
function! s:WpHookCommandConstructor(container)
  ...
  let wpHookCommandObj.get_auto_register = function('s:WpHookCommand_get_auto_register')
  let wpHookCommandObj.has_ex_mode = function('s:WpHookCommand_has_ex_mode')
  let wpHookCommandObj.get_completer = function('s:WpHookCommand_get_completer')
  let wpHookCommandObj.has_ctrlp_mode = function('s:WpHookCommand_has_ctrlp_mode')
  let wpHookCommandObj.get_count = function('s:WpHookCommand_get_count')
  let wpHookCommandObj.cmd_line_has_bang = function('s:WpHookCommand_cmd_line_has_bang')
  let wpHookCommandObj.remove_uid_prefix = function('s:WpHookCommand_remove_uid_prefix')
  let wpHookCommandObj.add_uid_prefix = function('s:WpHookCommand_add_uid_prefix')
  let wpHookCommandObj.filter_hooks = function('s:WpHookCommand_filter_hooks')
  let wpHookCommandObj.get_tags_for_uid = function('s:WpHookCommand_get_tags_for_uid')
  let wpHookCommandObj.get_hooks_for = function('s:WpHookCommand_get_hooks_for')
  let wpHookCommandObj.get_ctag_kind = function('s:WpHookCommand_get_ctag_kind')
  let wpHookCommandObj.get_kind_uid = function('s:WpHookCommand_get_kind_uid')
  let wpHookCommandObj.complete = function('s:WpHookCommand_complete')
  let wpHookCommandObj.run = function('s:WpHookCommand_run')
...
function! s:WpActionCommandConstructor(container)
  ...
  let wpActionCommandObj.get_name = function('s:WpActionCommand_get_name')
  let wpActionCommandObj.get_ctrlp_names = function('s:WpActionCommand_get_ctrlp_names')
  let wpActionCommandObj.get_ctag_kind = function('s:WpActionCommand_get_ctag_kind')
...
function! s:WpFilterCommandConstructor(container)
  ...
  let wpFilterCommandObj.get_name = function('s:WpFilterCommand_get_name')
  let wpFilterCommandObj.get_ctrlp_names = function('s:WpFilterCommand_get_ctrlp_names')
  let wpFilterCommandObj.get_ctag_kind = function('s:WpFilterCommand_get_ctag_kind')
...
function! s:ValidateReadmeCommandConstructor(container)
  ...
  let validateReadmeCommandObj.get_name = function('s:ValidateReadmeCommand_get_name')
  let validateReadmeCommandObj.get_auto_register = function('s:ValidateReadmeCommand_get_auto_register')
  let validateReadmeCommandObj.has_ex_mode = function('s:ValidateReadmeCommand_has_ex_mode')
  let validateReadmeCommandObj.get_nargs = function('s:ValidateReadmeCommand_get_nargs')
  let validateReadmeCommandObj.run = function('s:ValidateReadmeCommand_run')
  let validateReadmeCommandObj.get_project_readme = function('s:ValidateReadmeCommand_get_project_readme')
  let validateReadmeCommandObj.display_list = function('s:ValidateReadmeCommand_display_list')
...
function! s:ReadmeAutoValidatorCommandConstructor(container)
  ...
  let readmeAutoValidatorCommandObj.get_name = function('s:ReadmeAutoValidatorCommand_get_name')
  let readmeAutoValidatorCommandObj.get_auto_register = function('s:ReadmeAutoValidatorCommand_get_auto_register')
  let readmeAutoValidatorCommandObj.has_ex_mode = function('s:ReadmeAutoValidatorCommand_has_ex_mode')
  let readmeAutoValidatorCommandObj.run = function('s:ReadmeAutoValidatorCommand_run')
  let readmeAutoValidatorCommandObj.before_file_save = function('s:ReadmeAutoValidatorCommand_before_file_save')
  let readmeAutoValidatorCommandObj.after_file_save = function('s:ReadmeAutoValidatorCommand_after_file_save')
...
function! s:ControllerConstructor()
  ...
  let controllerObj.lookup = function('s:Controller_lookup')
