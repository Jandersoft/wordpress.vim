...
function! s:WordPressPluginConstructor()
  ...
  let wordPressPluginObj.start = function('s:WordPressPlugin_start')
  let wordPressPluginObj.loaded = function('s:WordPressPlugin_loaded')
  let wordPressPluginObj.get_app = function('s:WordPressPlugin_get_app')
  let wordPressPluginObj.on_buffer_open = function('s:WordPressPlugin_on_buffer_open')
  let wordPressPluginObj.on_buffer_enter = function('s:WordPressPlugin_on_buffer_enter')
  let wordPressPluginObj.on_buffer_leave = function('s:WordPressPlugin_on_buffer_leave')
  let wordPressPluginObj.on_vim_enter = function('s:WordPressPlugin_on_vim_enter')
  let wordPressPluginObj.can_autostart = function('s:WordPressPlugin_can_autostart')
  let wordPressPluginObj.has_args = function('s:WordPressPlugin_has_args')
  let wordPressPluginObj.has_autostart_option = function('s:WordPressPlugin_has_autostart_option')
  let wordPressPluginObj.has_wordpress = function('s:WordPressPlugin_has_wordpress')
